...
module.exports = function () {
  ...
  this.create = async (newBook, result) => {
    console.log(newBook.urlBook);
    var query = `
        INSERT INTO BOOK (title, price, author, publisher, pubYear, description, urlBook, sold_number, amountInStorage)
        VALUES (@title, @price, @author, 
                @publisher, @pubYear, @description, @urlBook, 0, @amountInStorage);`;
